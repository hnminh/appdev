...
// 80 pieces of decibel value, we know we need to calculate
// one decibel value from 200 samples, decibel value is calculated
// by RMS formula
void displayWAVDATA(short s[]){
	double rms[80];
	int dB[80];		// used to send decibel values to barchart
	short *ptr = s;		// we use a pointer, pointing to the begining of array
